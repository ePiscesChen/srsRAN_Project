...
dn_gateway_impl::dn_gateway_impl(udp_network_gateway_config                   config_,
...
bool dn_gateway_impl::is_initialized()
{
  return sock_fd != -1;
}

void dn_gateway_impl::handle_pdu(byte_buffer pdu, const sockaddr_storage& dest_addr)
{
...
void dn_gateway_impl::handle_pdu_impl(const byte_buffer& pdu, const sockaddr_storage& dest_addr)
{
...
bool dn_gateway_impl::create_and_bind()
{
...
int dn_gateway_impl::get_socket_fd()
{
  return sock_fd;
}

optional<uint16_t> dn_gateway_impl::get_bind_port()
{
  if (not is_initialized()) {
...
bool dn_gateway_impl::get_bind_address(std::string& ip_address)
{
...
bool dn_gateway_impl::set_sockopts()
{
...
bool dn_gateway_impl::set_non_blocking()
{
...
bool dn_gateway_impl::set_receive_timeout(unsigned rx_timeout_sec)
{
  struct timeval tv;
...
bool dn_gateway_impl::set_reuse_addr()
{
  int one = 1;
...
bool dn_gateway_impl::close_socket()
{
  if (not is_initialized()) {
    return true;
  }
